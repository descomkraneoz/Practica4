...
public class PoblacionActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        int[] localidades = {R.array.localidades_albacete, R.array.localidades_alava, R.array.localidades_alicante, R.array.localidades_almeria,
                ...
                R.array.localidades_lerida, R.array.localidades_leon, R.array.localidades_lugo, R.array.localidades_madrid, R.array.localidades_malaga,
                R.array.localidades_melilla, R.array.localidades_murcia, R.array.localidades_navarra, R.array.localidades_orense,
                R.array.localidades_palencia, R.array.localidades_pontevedra, R.array.localidades_salamanca,
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, localidades[position], android.R.layout.simple_spinner_dropdown_item);
